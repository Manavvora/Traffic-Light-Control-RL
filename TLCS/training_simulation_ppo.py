...
class Simulation:
    def __init__(self, Model, opt_epochs, RolloutBuffer, TrafficGen, sumo_cmd, gamma, max_steps, green_duration, yellow_duration, num_states, num_actions, training_epochs):
        self._policy = Model
