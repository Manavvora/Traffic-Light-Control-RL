...
from testing_simulation_ppo import Simulation_PPO
from generator import TrafficGenerator
from model_ppo import TestModel_PPO
from visualization import Visualization as vz
from utils_ppo import import_test_configuration, set_sumo, set_test_path


def run_ppo_test():
# if __name__ == "__main__":

    config = import_test_configuration(config_file='testing_settings_ppo.ini')
